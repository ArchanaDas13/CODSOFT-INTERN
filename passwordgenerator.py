...
#importing the statements we need
import string
import random
from tkinter import *
...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='darkblue', bg='#ADD8E6', font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='#ADD8E6', fg='darkblue')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='#ADD8E6', fg='darkblue')  # Light yellow
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='#ADD8E6', fg='darkblue')  # Light green
